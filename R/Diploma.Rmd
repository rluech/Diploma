...
```{r, echo = FALSE, fig.cap = "\\label{fig:fig9} Variable importance plots for the multinomial full model, the reduced model and random forest." }
...
```{r, echo = FALSE, fig.align = "center", out.width = "55%", fig.cap = "\\label{fig:fig13} Random forest partial dependence plot for the amount of TV viewing between 17 and 20 o'clock during workdays. " }
