...
However, we know the probability of each household size category in our sample. And therefore can calculate a more precise estimate for the probability of classifying 
a correctly by chance:
